...
The complete PPO–Pointer model had normalized D6 training stability of 0.9860 and D7 sample efficiency of 0.9654. A2C–Pointer had 0.9701 and 0.9466. In paired seed-level tests, the D6 and D7 complete-minus-A2C mean differences were 0.0159 and 0.0187; both Holm-adjusted p values were 0.125 with five seeds. The dimensions therefore provide directional and descriptive training evidence, not separately confirmed superiority at α = 0.05.

An operational 100-point arithmetic summary assigned 76.656 to PPO–Pointer, 74.547 to A2C–Pointer and 54.467 to Flat-MLP PPO under its selected normalization and weights. A map-outer hierarchical bootstrap estimated a PPO-minus-A2C score difference of 1.986 points (95% interval 0.784–3.206; 10,000 resamples). This score was designed after results were available, combines heterogeneous dimensions and changes under weighting/normalization choices. It is a diagnostic summary only and does not replace safe weighted coverage.
