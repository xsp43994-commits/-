...
$names = @(
    "EAAI_manuscript_anonymized_v3",
    "EAAI_manuscript_two_column_reading_proof_v3",
    "EAAI_title_page_v3",
    "EAAI_supplementary_material_v3",
    "EAAI_highlights_v3",
    "EAAI_cover_letter_v3",
    "EAAI_manuscript_zh_v3",
    "EAAI_title_page_zh_v3",
    "EAAI_supplementary_material_zh_v3",
    "EAAI_highlights_zh_v3",
    "EAAI_cover_letter_zh_v3"
)
