...
def main() -> None:
    ...
    report = {
        ...
        "pending_matlab": "V02 Chinese route is rendered by render_V02_zh_v3.m",
    }
    (QA / "figure_manifest_pre_matlab_v3.json").write_text(json.dumps(report, ensure_ascii=False, indent=2), encoding="utf-8")
