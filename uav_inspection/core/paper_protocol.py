...
DEFAULT_CODE_FILES: Tuple[str, ...] = (
    "uav_inspection/core/final_python_ppo_pointer.py",
    "uav_inspection/core/ppo_training_scenario.py",
    "uav_inspection/experiments/paper_experiments.py",
    "uav_inspection/core/paper_evaluation.py",
    "uav_inspection/core/paper_protocol.py",
)
...
def build_frozen_protocol(
    ...
    *,
    ...
    root = Path(repo_root) if repo_root is not None else WORKSPACE_ROOT
