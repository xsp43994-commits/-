...
def _scenario_module() -> Any:
    return importlib.import_module("uav_inspection.core.ppo_training_scenario")


def _ppo_module() -> Any:
    return importlib.import_module("uav_inspection.core.final_python_ppo_pointer")
...
def _protocol_for_run(
    ...
    if cached is None and protocol_path is None:
        return None
    module = importlib.import_module("uav_inspection.core.paper_protocol")
    protocol = (
        dict(cached)
...
def _aggregate(args: argparse.Namespace) -> Path:
    ...
    if args.dry_run:
        ...
        return output_dir
    module = importlib.import_module("uav_inspection.core.paper_evaluation")
    ...
    if args.protocol is not None:
        ...
        protocol_module = importlib.import_module("uav_inspection.core.paper_protocol")
...
def _doctor(args: argparse.Namespace) -> int:
    ...
    try:
        evaluation = importlib.import_module("uav_inspection.core.paper_evaluation")
    ...
    try:
        protocol = importlib.import_module("uav_inspection.core.paper_protocol")
        required = (
